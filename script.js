...
<figure id = 'fig3-2'><img src='/images/embriao.png' alt='LourinhanhosaurusEmbriao'width='328' height='225'>\
<figcaption>Embrião de Lourinhanhosaurus antunesi</figcaption></figure>\
<h3>Lourinhanhosaurus antunesi</h3> <h5>Classificação:&nbspTerópode<br>Período:&nbspJurássico Superior</h5>\
<p>Os primeiros registos fósseis desta espécie foram descobertos em 1982, em Peralta. Em Porto das Barcas foi também encontrado um fémur deste dinossauro carnívoro de dimensões médias, juntamente com vários ovos e embriões deste espécime. Como o nome indica, foi descoberto na Lourinhã, e é um dos esqueletos mais completos que temos em Portugal!<p>"
...
<figure id = 'fig5-2'><img src='/images/lusotitan2.jpg' alt='Lusotitan2' width='365' height='274'>\
<figcaption>Osso do Lusotitan - Museu Geológico de Lisboa</figcaption></figure>\
...
<h3>Dracopelta zbyszewskii</h3> <h5>Classificação:&nbspOrnitísquio<br>Período:&nbspJurássico Superior</h5>\
<p>Este dinossauro foi descoberto em 1980 por Peter Galton, a zona da descoberta é uma questão controversa pois não se sabe ao certo se foi em Ribamar, no concelho da Ericeira ou em Ribamar, no concelho da Lourinhã, mas acredita-se que o mais provável é ter ocorrido no concelho da Ericeira. Este dinossauro era de pequeno porte e tinha o seu dorso revestido de placas ósseas. É possível observar o seu esqueleto fossilizado no Museu Geológico de Lisboa e no Museu da Lourinhã.<p>"
...
<figcaption>Fóssil de Portugalosuchus azenhae, Direitos Reservados</figcaption></figure>\
<h3>Portugalosuchus azenhae</h3><h5>Classificação:&nbspCrocodylia<br>Período:&nbspCretácico Superior</h5>\
<p>Em 2003, paleontólogos portugueses descobriram uma nova espécie de crocodilo fóssil com 95 milhões de anos. Foi encontrado em Tentúgal e, em 2018, a espécie foi batizada de Portugalosuchus azenhae, para homenagear Matilde Azenha, que foi quem descobriu o crânio fossilizado deste crocodilo. Como afirma Octávio Mateus, “Este fóssil é único na sua anatomia e é a peça-chave para compreender as fases iniciais da evolução dos crocodilos, por ser o mais antigo do grupo a que chamamos Crocodylia, os verdadeiros crocodilos”.<p>"
...
function changeText(number) {
  ...
  switch(number){
    case "1":
      targetDiv.innerHTML = content1;
      break;
    case "2":
      targetDiv.innerHTML = content2;
      break;
    case "3":
      targetDiv.innerHTML = content3;
      break;
    case "4":
      targetDiv.innerHTML = content4;
      break;
    case "5":
      targetDiv.innerHTML = content5;
      break;
    case "6":
      targetDiv.innerHTML = content6;
      break;
    case "7":
      targetDiv.innerHTML = content7;
      break;
    case "8":
      targetDiv.innerHTML = content8;
      break;
    case "9":
      targetDiv.innerHTML = content9;
      break;
    case "10":
      targetDiv.innerHTML = content10;
      break;
    case "11":
      targetDiv.innerHTML = content11;
      break;
    case "12":
      targetDiv.innerHTML = content12;
      break;
    case "13":
      targetDiv.innerHTML = content13;
      break;
    case "14":
      targetDiv.innerHTML = content14;
      break;
    case "15":
      targetDiv.innerHTML = content15;
      break;
  }
}

(function() {
  document.getElementById("b1").addEventListener("click", function() { changeText("1"); });
  document.getElementById("b2").addEventListener("click", function() { changeText("2"); });
  document.getElementById("b3").addEventListener("click", function() { changeText("3"); });
  document.getElementById("b4").addEventListener("click", function() { changeText("4"); });
  document.getElementById("b5").addEventListener("click", function() { changeText("5"); });
  document.getElementById("b6").addEventListener("click", function() { changeText("6"); });
  document.getElementById("b7").addEventListener("click", function() { changeText("7"); });
  document.getElementById("b8").addEventListener("click", function() { changeText("8"); });
  document.getElementById("b9").addEventListener("click", function() { changeText("9"); });
  document.getElementById("b10").addEventListener("click", function() { changeText("10"); });
  document.getElementById("b11").addEventListener("click", function() { changeText("11"); });
  document.getElementById("b12").addEventListener("click", function() { changeText("12"); });
  document.getElementById("b13").addEventListener("click", function() { changeText("13"); });
  document.getElementById("b14").addEventListener("click", function() { changeText("14"); });
  document.getElementById("b15").addEventListener("click", function() { changeText("15"); });
})();